...
_PLATFORMS = [
    ...
    },
    {
        ...
        "label": "Sesame",
        "emoji": "🌱",
        "token_var": "SESAME_API_KEY",
        "setup_instructions": [
            "1. Provision an agent on Sesame and generate an API key",
            "2. Set SESAME_API_KEY to that key",
            "3. Optional: set SESAME_HOME_CHANNEL for cron/notification delivery",
            "4. Hermes connects to Sesame realtime via WebSocket /v1/connect",
        ],
        "vars": [
            {"name": "SESAME_API_KEY", "prompt": "Sesame API key", "password": True,
             "help": "API key for this Hermes agent's Sesame principal."},
            {"name": "SESAME_ALLOWED_USERS", "prompt": "Allowed Sesame principal IDs (comma-separated, or empty for pairing/global policy)", "password": False,
             "is_allowlist": True,
             "help": "Optional — restrict access to specific Sesame principals."},
            {"name": "SESAME_HOME_CHANNEL", "prompt": "Home channel ID for cron/notifications (or empty)", "password": False,
             "help": "Sesame channel ID to deliver cron results and notifications to."},
            {"name": "SESAME_API_URL", "prompt": "Sesame API URL", "password": False,
             "default": "https://api.sesame.space", "help": "REST API base URL."},
            {"name": "SESAME_WS_URL", "prompt": "Sesame WebSocket URL", "password": False,
             "default": "wss://ws.sesame.space", "help": "Realtime WebSocket base URL."},
        ],
    },
    {
        "key": "yuanbao",
