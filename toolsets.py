...
TOOLSETS = {
    ...
    "hermes-sesame": {
        "description": "Sesame gateway toolset - first-party agent messaging with full core tool access",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
